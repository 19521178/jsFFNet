const glError = (gl, label) => {
  ...
  class GLProcessor {
    ...
    flipFramebuffers() {
      // flip read framebuffer to draw framebuffer
      ...
      this.gl.blitFramebuffer(
        ...
        this.gl.LINEAR
      ) // transfer data from read framebuffer to default framebuffer
    }
