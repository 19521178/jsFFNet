...
const InputContainer = function(fps, idContainer){
    ...
    // this.fcOnEscDown = onKeyDown.bind(this);
    ...
    this.inputVideoContainer.addEventListener('fullscreenchange', this.fcUpdateFullscreenButton);
    ...
    function removeEventListener(){
        ...
        this.inputVideoContainer.removeEventListener('fullscreenchange', this.fcUpdateFullscreenButton);
